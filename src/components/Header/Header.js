...
import { BeakerIcon, QuestionMarkCircleIcon } from '@heroicons/react/24/solid'
    ...
    return (
        <div className='relative flex flex-wrap items-center justify-between px-2 py-3 bg-pink-500 mb-3'>
            ...
            <div class="navbar bg-base-100">
                ...
                <div class="navbar-start ">
                    <Link to='/home' class="btn btn-ghost normal-case text-3xl"><QuestionMarkCircleIcon className="h-6 w-6 text-blue-500"/> <span>Question<span className='text-red-500'>Box</span></span> </Link>
                </div>
